...
describe("Field Update Idempotency Integration Tests", () => {
    ...
    it("should not generate duplicate migrations for NumberField min:1 change and SelectField value expansion", async () => {
        ...
        const snapshot1Copy = JSON.parse(JSON.stringify({
            ...snapshot1,
        ...
        const totalChanges = diff3.collectionsToCreate.length + diff3.collectionsToDelete.length + diff3.collectionsToModify.length;
